...
TIER1=$(echo "$STAGED" | grep -E "knowledge/_index\\.yaml|knowledge/sync/drift-log\\.md|knowledge/sync/changelog\\.md" || true)
if [ -n "$TIER1" ]; then
